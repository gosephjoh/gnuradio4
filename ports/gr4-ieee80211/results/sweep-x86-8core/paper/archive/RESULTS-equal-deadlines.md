> **Archived 2026-09-18.** This is the evaluation of the equal-deadline sweep
> (every block with a relative deadline of one batch period). It was superseded
> by `../RESULTS.md`, which adds the deadline-structure experiment (a
> control-channel receiver at a tighter deadline, a tighter frame path) and the
> microbenchmarks that check the mechanisms claimed here. The figures it embeds
> are unchanged and live in the parent directory.
